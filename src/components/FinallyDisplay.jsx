...
const FinallyDisplay = () => {
  ...
  useEffect(() => {
      axios
        ...
        const convertedGeoJSON = latLongToCoordinates(geojsonObject.geometry.coordinates);
    ...
    useEffect(() => {
        if (geojsonObject) {
          ...
          latLongToCoordinates(geojsonObject.geometry.coordinates, setPolygonList);
        }
      }, [geojsonObject]);
